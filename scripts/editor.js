 ...
 * Original file: /npm/@editorjs/editorjs@2.30.8/dist/editorjs.umd.js
 *
...
(function (J, ne) {
  typeof exports == "object" && typeof module < "u" ? module.exports = ne() : typeof define == "function" && define.amd ? define(ne) : (J = typeof globalThis < "u" ? globalThis : J || self, J.EditorJS = ne())
})(this, function () {
  "use strict";
  ...
  Object.assign(tt, {
    default: tt, register: tt, revert: function () {
    }, __esModule: !0
    ...
    const e = this.parentNode, t = window.getComputedStyle(e, null),
      o = parseInt(t.getPropertyValue("border-top-width")), i = parseInt(t.getPropertyValue("border-left-width")),
      ...
      l = this.offsetLeft - e.offsetLeft + this.clientWidth - i > e.scrollLeft + e.clientWidth, c = s && !r;
  ...
  let Kn = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
  var ko = (n => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(ko || {});
  const y = {
    BACKSPACE: 8,
    TAB: 9,
    ENTER: 13,
  ...
  const T = ye.bind(window, !1), X = ye.bind(window, !0);
  ...
  function nt(n, ...e) {
    ...
    const t = e.shift();
    if (N(n) && N(t)) for (const o in t) N(t[o]) ? (n[o] || Object.assign(n, {[o]: {}}), nt(n[o], t[o])) : Object.assign(n, {[o]: t[o]});
    return nt(n, ...e)
  }
  ...
  const rt = typeof window < "u" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);

  function ii(n, e) {
    const t = Array.isArray(n) || N(n), o = Array.isArray(e) || N(e);
  ...
  class d {
    ...
    static findAllInputs(e) {
      return xo(e.querySelectorAll(d.allInputsSelector)).reduce((t, o) => d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)], [])
    }
    ...
    static offset(e) {
      const t = e.getBoundingClientRect(), o = window.pageXOffset || document.documentElement.scrollLeft,
        i = window.pageYOffset || document.documentElement.scrollTop, s = t.top + i, r = t.left + o;
  ...
  function ri(n) {
    const e = window.getComputedStyle(n), t = parseFloat(e.fontSize), o = parseFloat(e.lineHeight) || t * 1.2,
      i = parseFloat(e.paddingTop), s = parseFloat(e.borderTopWidth), r = parseFloat(e.marginTop), a = t * .8,
      l = (o - t) / 2;
    return r + s + i + l + a
  }
  ...
  const So = {
    ...
    static getNamespace(e) {
      return e.split(".").reduce((o, i) => !o || !Object.keys(o).length ? {} : o[i], ke.currentDictionary)
    }
  };
  ...
  class Ee {
    ...
    on(e, t, o, i = !1) {
      const s = ni("l"), r = {id: s, element: e, eventType: t, handler: o, options: i};
  ...
  class b {
    ...
    static get rect() {
      let e = document.selection, t, o = {x: 0, y: 0, width: 0, height: 0};
  ...
  const at = "redactor dom changed", _o = "block changed", Mo = "fake cursor is about to be toggled",
    Ao = "fake cursor have been set", xe = "editor mobile layout toggled";
  ...
  async function Po(n, e) {
    ...
    return i !== void 0 && !lt(i, "export") ? [] : e.reduce((s, r) => {
  ...
  function No(n, e) {
    return n.mergeable ? n.name === e.name ? !0 : Pe(e, "export") && Pe(n, "import") : !1
  }

  function li(n, e) {
    const t = e == null ? void 0 : e.export;
    return M(t) ? t(n) : Q(t) ? n[t] : (t !== void 0 && T("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "")
  }

  function Ro(n, e, t) {
    const o = e == null ? void 0 : e.import;
    return M(o) ? o(n, t) : Q(o) ? {[o]: n} : (o !== void 0 && T("Conversion «import» property must be a string or function. String means key of tool data to import. Function accepts a imported string and return composed tool data."), {})
  }

  var _ = (n => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(_ || {}),
    te = (n => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(te || {});

  class R extends we {
    constructor({id: e = ti(), data: t, tool: o, readOnly: i, tunesData: s}, r) {
      super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = new Map, this.defaultTunesInstances = new Map, this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
        ...
        l || c ? u = !0 : u = !(a.length > 0 && a.every(p => {
          ...
          return [...Array.from(g), ...Array.from(f), v].some(S => (d.isElement(S) || (S = S.parentElement), S && S.closest('[data-mutation-free="true"]') !== null))
        })), u && (this.dropInputsCache(), this.updateCurrentInput(), this.toggleInputsEmptyMark(), this.call("updated"), this.emit("didMutated", this))
      }, this.name = o.name, this.id = e, this.settings = o.settings, this.config = o.settings.config || {}, this.editorEventBus = r || null, this.blockAPI = new ee(this), this.tool = o, this.toolInstance = o.create(t, this.blockAPI, i), this.tunes = o.tunes, this.composeTunes(s), this.holder = this.compose(), window.requestIdleCallback(() => {
    ...
    set selected(e) {
      ...
      (t || o) && ((i = this.editorEventBus) == null || i.emit(Mo, {state: e}), t ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Ao, {state: e}))
    }
    ...
    getTunes() {
      ...
      return d.isElement(o) ? e.push({
        ...
        d.isElement(s) ? t.push({type: _.Html, element: s}) : Array.isArray(s) ? t.push(...s) : t.push(s)
  ...
  class ci extends E {
    constructor() {
      super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
        const l = this.Editor.BlockManager.insert({id: a, tool: e, data: t, index: i, needToFocus: s, replace: r});
        return new ee(l)
      }, this.composeBlockData = async e => {
        const t = this.Editor.Tools.blockTools.get(e);
        return new R({tool: t, api: this.Editor.API, readOnly: !0, data: {}, tunesData: {}}).data
        ...
        if (c && u) {
          ...
          const g = [c ? !1 : Le(r.name), u ? !1 : Le(t)].filter(Boolean).join(" and ");
    ...
    getById(e) {
      const t = this.Editor.BlockManager.getBlockById(e);
      return t === void 0 ? (X("There is no block with id `" + e + "`", "warn"), null) : new ee(t)
    }
  ...
  class ct extends E {
    ...
    getMethodsForTool(e, t) {
      return Object.assign(this.methods, {t: o => H.t(ct.getNamespace(e, t), o)})
    }
  }
...
`)
        ...
        function v(k, m) {
          for (var w = [], x = {}, I = 0; I < k.length; I++) {
            var C = k[I], D = m.base ? C[0] + m.base : C[0], B = {css: C[1], media: C[2], sourceMap: C[3]};
            x[D] ? x[D].parts.push(B) : w.push(x[D] = {id: D, parts: [B]})
          }
          return w
        }
...
`);
        ...
        function A(k) {
          ...
          return k.attrs.type === void 0 && (k.attrs.type = "text/css"), G(m, k.attrs), O(k, m), m
        }
        ...
        function j(k, m) {
          ...
          if (m.singleton) {
            var D = h++;
            w = u || (u = A(m)), x = he.bind(null, w, D, !1), I = he.bind(null, w, D, !0)
            ...
            return B.attrs.type === void 0 && (B.attrs.type = "text/css"), B.attrs.rel = "stylesheet", G(K, B.attrs), O(B, K), K
          }(m), x = (function (B, K, Oe) {
            var pe = Oe.css, vo = Oe.sourceMap, Ca = K.convertToAbsoluteUrls === void 0 && vo;
            (K.convertToAbsoluteUrls || Ca) && (pe = g(pe)), vo && (pe += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(vo)))) + " */");
            var Ta = new Blob([pe], {type: "text/css"}), $n = B.href;
            B.href = URL.createObjectURL(Ta), $n && URL.revokeObjectURL($n)
          }).bind(null, w, m), I = function () {
            S(w), w.href && URL.revokeObjectURL(w.href)
          }) : (w = A(m), x = (function (B, K) {
            var Oe = K.css, pe = K.media;
            if (pe && B.setAttribute("media", pe), B.styleSheet) B.styleSheet.cssText = Oe; else {
        ...
        var U, oe = (U = [], function (k, m) {
          return U[k] = m, U.filter(Boolean).join(`
`)
        });

        function he(k, m, w, x) {
          var I = w ? "" : x.css;
          if (k.styleSheet) k.styleSheet.cssText = oe(m, I); else {
            var C = document.createTextNode(I), D = k.childNodes;
            D[m] && k.removeChild(D[m]), D.length ? k.insertBefore(C, D[m]) : k.appendChild(C)
          }
        }
      }, function (t, o) {
        t.exports = function (i) {
        ...
        t.exports = (s = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", p = "cdx-notify__btns-wrapper", {
          alert: g = function (f) {
            var v = document.createElement("DIV"), O = document.createElement("DIV"), S = f.message, A = f.style;
            return v.classList.add(r), A && v.classList.add(r + "--" + A), v.innerHTML = S, O.classList.add(a), O.addEventListener("click", v.remove.bind(v)), v.appendChild(O), v
          }, confirm: function (f) {
            var v = g(f), O = document.createElement("div"), S = document.createElement("button"),
              A = document.createElement("button"), G = v.querySelector("." + a), j = f.cancelHandler, U = f.okHandler;
            return O.classList.add(p), S.innerHTML = f.okText || "Confirm", A.innerHTML = f.cancelText || "Cancel", S.classList.add(h), A.classList.add(h), S.classList.add(l), A.classList.add(c), j && typeof j == "function" && (A.addEventListener("click", j), G.addEventListener("click", j)), U && typeof U == "function" && S.addEventListener("click", U), S.addEventListener("click", v.remove.bind(v)), A.addEventListener("click", v.remove.bind(v)), O.appendChild(S), O.appendChild(A), v.appendChild(O), v
          }, prompt: function (f) {
            var v = g(f), O = document.createElement("div"), S = document.createElement("button"),
              A = document.createElement("input"), G = v.querySelector("." + a), j = f.cancelHandler, U = f.okHandler;
            return O.classList.add(p), S.innerHTML = f.okText || "Ok", S.classList.add(h), S.classList.add(l), A.classList.add(u), f.placeholder && A.setAttribute("placeholder", f.placeholder), f.default && (A.value = f.default), f.inputType && (A.type = f.inputType), j && typeof j == "function" && G.addEventListener("click", j), U && typeof U == "function" && S.addEventListener("click", function () {
              U(A.value)
            }), S.addEventListener("click", v.remove.bind(v)), O.appendChild(A), O.appendChild(S), v.appendChild(O), v
          }, getWrapper: function () {
  ...
  class yi extends E {
    get methods() {
      ...
      return {
        toggle: t => this.toggle(t), get isEnabled() {
          return e()
        }
      }
    }
    ...
    (function (t, o) {
      ...
      t.prototype.clean = function (h) {
        ...
        if (f) do {
          ...
          var S = !!p.parentNode, A = i(p) && i(f) && S, G = f.nodeName.toLowerCase(), j = l(this.config, G, f),
            U = v && O;
          ...
          for (var oe = 0; oe < f.attributes.length; oe += 1) {
            ...
            u(he, j, f) && (f.removeAttribute(he.name), oe = oe - 1)
          }
          this._sanitize(h, f)
 ...
 */
    ...
    (function (t, o) {
      ...
      return function (t) {
        ...
        class s {
          ...
          placeBottom(a, l) {
            const c = a.getBoundingClientRect(), u = c.left + a.clientWidth / 2 - this.nodes.wrapper.offsetWidth / 2,
          ...
          placeRight(a, l) {
            const c = a.getBoundingClientRect(), u = c.right + this.offsetRight + l.marginRight,
              h = c.top + window.pageYOffset + a.clientHeight / 2 - this.nodes.wrapper.offsetHeight / 2;
  ...
  const $o = class _e {
    ...
    leafNodesAndReturnIndex(e) {
      ...
      let t = this.cursor;
      return t === -1 ? t = e === _e.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === _e.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, d.canSetCaret(this.items[t]) && Ae(() => b.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t
    }
  };
  ...
  class ae {
    constructor(e) {
      this.iterator = null, this.activated = !1, this.flipCallbacks = [], this.onKeyDown = t => {
        if (this.isEventReadyForHandling(t)) switch (ae.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
          case y.TAB:
      ...
      }, this.iterator = new Be(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || ae.usedKeys
    }
  ...
  const Hi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>',
    $i = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>',
    zi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.5 17.5L9.64142 12.6414C9.56331 12.5633 9.56331 12.4367 9.64142 12.3586L14.5 7.5"/></svg>',
    Ui = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9.58284 17.5L14.4414 12.6414C14.5195 12.5633 14.5195 12.4367 14.4414 12.3586L9.58284 7.5"/></svg>',
    Wi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>',
    Yi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>',
    Ki = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>',
    Xi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>',
    zo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>',
    ...
    qi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>',
    Uo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M11.5 17.5L5 11M5 11V15.5M5 11H9.5"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12.5 6.5L19 13M19 13V8.5M19 13H14.5"/></svg>',
    Zi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>',
    Gi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>',
    Ji = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>',
    Qi = "__", es = "--";

  function ie(n) {
    return (e, t) => [[n, e].filter(i => !!i).join(Qi), t].filter(i => !!i).join(es)
  }

  const Ce = ie("ce-hint"), Te = {
    root: Ce(),
  ...
  class ts {
    constructor(e) {
      this.nodes = {
        root: d.make("div", [Te.root, e.alignment === "center" ? Te.alignedCenter : Te.alignedStart]),
        title: d.make("div", Te.title, {textContent: e.title})
      }, this.nodes.root.appendChild(this.nodes.title), e.description !== void 0 && (this.nodes.description = d.make("div", Te.description, {textContent: e.description}), this.nodes.root.appendChild(this.nodes.description))
    }
  ...
  class le extends pt {
    ...
    make(e, t) {
      ...
      return e.name && (i.dataset.itemName = e.name), this.nodes.icon = d.make("div", [L.icon, L.iconTool], {innerHTML: e.icon || Ki}), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(d.make("div", L.title, {innerHTML: e.title || ""})), e.secondaryLabel && i.appendChild(d.make("div", L.secondaryTitle, {textContent: e.secondaryLabel})), this.hasChildren && i.appendChild(d.make("div", [L.icon, L.iconChevronRight], {innerHTML: Ui})), this.isActive && i.classList.add(L.active), e.isDisabled && i.classList.add(L.disabled), e.hint !== void 0 && ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== !1 && this.addHint(i, {
        ...e.hint,
    ...
    enableConfirmationMode(e) {
      ...
      const t = {...this.params, ...e, confirmation: "confirmation" in e ? e.confirmation : void 0}, o = this.make(t);
  ...
  const ft = ie("ce-popover-item-separator"), gt = {container: ft(), line: ft("line"), hidden: ft(null, "hidden")};

  class Wo extends pt {
    constructor() {
      super(), this.nodes = {
        root: d.make("div", gt.container),
        line: d.make("div", gt.line)
  ...
  var me = (n => (n.NestingLevel = "--nesting-level", n.PopoverHeight = "--popover-height", n.InlinePopoverWidth = "--inline-popover-width", n.TriggerItemLeft = "--trigger-item-left", n.TriggerItemTop = "--trigger-item-top", n))(me || {});
  const Yo = ie("ce-popover-item-html"), Ko = {root: Yo(), hidden: Yo(null, "hidden")};

  class Se extends pt {
    constructor(e, t) {
      var o, i;
      super(e), this.nodes = {root: d.make("div", Ko.root)}, this.nodes.root.appendChild(e.element), e.name && (this.nodes.root.dataset.itemName = e.name), e.hint !== void 0 && ((o = t == null ? void 0 : t.hint) == null ? void 0 : o.enabled) !== !1 && this.addHint(this.nodes.root, {
        ...e.hint,
  ...
  class Xo extends we {
    constructor(e, t = {}) {
      super(), this.params = e, this.itemsRenderParams = t, this.listeners = new Ee, this.messages = {
        nothingFound: "Nothing found",
        search: "Search"
      }, this.items = this.buildItems(e.items), e.messages && (this.messages = {...this.messages, ...e.messages}), this.nodes = {}, this.nodes.popoverContainer = d.make("div", [P.popoverContainer]), this.nodes.nothingFoundMessage = d.make("div", [P.nothingFoundMessage], {textContent: this.messages.nothingFound}), this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = d.make("div", [P.items]), this.items.forEach(o => {
    ...
    hide() {
      this.nodes.popover.classList.remove(P.popoverOpened), this.nodes.popover.classList.remove(P.popoverOpenTop), this.itemsDefault.forEach(e => e.reset()), this.search !== void 0 && this.search.clear(), this.emit(Z.Closed)
    }
    ...
    getTargetItem(e) {
      return this.items.filter(t => t instanceof le || t instanceof Se).find(t => {
    ...
    toggleItemActivenessIfNeeded(e) {
      if (e instanceof le && (e.toggle === !0 && e.toggleActive(), typeof e.toggle == "string")) {
  ...
  const mt = ie("cdx-search-field"), bt = {wrapper: mt(), icon: mt("icon"), input: mt("input")};

  class os extends we {
    constructor({items: e, placeholder: t}) {
      super(), this.listeners = new Ee, this.items = e, this.wrapper = d.make("div", bt.wrapper);
      const o = d.make("div", bt.icon, {innerHTML: Zi});
      this.input = d.make("input", bt.input, {
        placeholder: t,
        tabIndex: -1
      }), this.wrapper.appendChild(o), this.wrapper.appendChild(this.input), this.listeners.on(this.input, "input", () => {
        this.searchQuery = this.input.value, this.emit(De.Search, {query: this.searchQuery, items: this.foundItems})
      })
    }
    ...
    clear() {
      this.input.value = "", this.searchQuery = "", this.emit(De.Search, {query: "", items: this.foundItems})
    }
  ...
  var ns = Object.defineProperty, is = Object.getOwnPropertyDescriptor, ss = (n, e, t, o) => {
    for (var i = o > 1 ? void 0 : o ? is(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  const Vo = class zn extends Xo {
    constructor(e, t) {
      super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
        ...
        this.items.forEach(l => {
          let c = !1;
          l instanceof le ? c = !o.items.includes(l) : (l instanceof Wo || l instanceof Se) && (c = s || !i), l.toggleHidden(c)
    ...
    show() {
      var e;
      this.nodes.popover.style.setProperty(me.PopoverHeight, this.size.height + "px"), this.shouldOpenBottom || this.nodes.popover.classList.add(P.popoverOpenTop), this.shouldOpenRight || this.nodes.popover.classList.add(P.popoverOpenLeft), super.show(), (e = this.flipper) == null || e.activate(this.flippableElements)
    }
    ...
    showNestedPopoverForItem(e) {
      ...
      return this.nodes.popover.appendChild(t), this.setTriggerItemPosition(t, e), t.style.setProperty(me.NestingLevel, this.nestedPopover.nestingLevel.toString()), this.nestedPopover.show(), (o = this.flipper) == null || o.deactivate(), this.nestedPopover
    }

    get shouldOpenBottom() {
      if (this.nodes.popover === void 0 || this.nodes.popover === null) return !1;
      const e = this.nodes.popoverContainer.getBoundingClientRect(), t = this.scopeElement.getBoundingClientRect(),
        o = this.size.height, i = e.top + o, s = e.top - o, r = Math.min(window.innerHeight, t.bottom);
      return s < t.top || i <= r
    }

    get shouldOpenRight() {
      if (this.nodes.popover === void 0 || this.nodes.popover === null) return !1;
      const e = this.nodes.popover.getBoundingClientRect(), t = this.scopeElement.getBoundingClientRect(),
        o = this.size.width, i = e.right + o, s = e.left - o, r = Math.min(window.innerWidth, t.right);
      return s < t.left || i <= r
    }
  ...
  class rs extends vt {
    constructor(e) {
      const t = !ge();
      super({...e, class: P.popoverInline}, {
        [_.Default]: {
          wrapperTag: "button",
          hint: {position: "top", alignment: "center", enabled: t}
        }, [_.Html]: {hint: {position: "top", alignment: "center", enabled: t}}
      }), this.items.forEach(o => {
        !(o instanceof le) && !(o instanceof Se) || o.hasChildren && o.isChildrenOpen && this.showNestedItems(o)
      })
    }
    ...
    show() {
      this.nestingLevel === 0 && this.nodes.popover.style.setProperty(me.InlinePopoverWidth, this.size.width + "px"), super.show()
    }
  ...
  const qo = class Me {
    ...
    unlock() {
      rt ? this.unlockHard() : document.body.classList.remove(Me.CSS.scrollLocked)
    }

    lockHard() {
      this.scrollPosition = window.pageYOffset, document.documentElement.style.setProperty("--window-scroll-offset", `${this.scrollPosition}px`), document.body.classList.add(Me.CSS.scrollLockedHard)
    }
  ...
  qo.CSS = {scrollLocked: "ce-scroll-locked", scrollLockedHard: "ce-scroll-locked--hard"};
  let as = qo;
  const kt = ie("ce-popover-header"), yt = {root: kt(), text: kt("text"), backButton: kt("back-button")};

  class ls {
    constructor({text: e, onBackButtonClick: t}) {
      this.listeners = new Ee, this.text = e, this.onBackButtonClick = t, this.nodes = {
        root: d.make("div", [yt.root]),
        backButton: d.make("button", [yt.backButton]),
        text: d.make("div", [yt.text])
      }, this.nodes.backButton.innerHTML = zi, this.nodes.root.appendChild(this.nodes.backButton), this.listeners.on(this.nodes.backButton, "click", this.onBackButtonClick), this.nodes.text.innerText = this.text, this.nodes.root.appendChild(this.nodes.text)
    }
  ...
  class Zo extends Xo {
    constructor(e) {
      ...
      }), this.scrollLocker = new as, this.history = new cs, this.isHidden = !0, this.nodes.overlay = d.make("div", [P.overlay, P.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
        this.hide()
  ...
  class ds extends E {
    ...
    make() {
      this.nodes.wrapper = d.make("div", [this.CSS.settings]), this.nodes.wrapper.setAttribute("data-cy", "block-tunes"), this.eventsDispatcher.on(xe, this.close)
    }
    ...
    async open(e = this.Editor.BlockManager.currentBlock) {
      ...
      this.popover = new i({
        ...
        messages: {nothingFound: H.ui(W.ui.popover, "Nothing found"), search: H.ui(W.ui.popover, "Filter")}
    ...
    async getTunesItems(e, t, o) {
      ...
      const s = Array.from(this.Editor.Tools.blockTools.values()),
        a = (await Po(e, s)).reduce((l, c) => (c.toolbox.forEach(u => {
          l.push({
            icon: u.icon,
            title: H.t(W.toolNames, u.title),
            name: c.name,
            closeOnActivate: !0,
            onActivate: async () => {
 ...
 */
  ...
  class ps {
    ...
    add(e) {
      ...
      const o = new hs({name: e.name, on: e.on, callback: e.handler}), i = this.registeredShortcuts.get(e.on) || [];
  ...
  const be = new ps;
  var fs = Object.defineProperty, gs = Object.getOwnPropertyDescriptor, Jo = (n, e, t, o) => {
      for (var i = o > 1 ? void 0 : o ? gs(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
      return o && i && fs(e, t, i), i
    },
    Fe = (n => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(Fe || {});
  const wt = class Un extends we {
    constructor({api: e, tools: t, i18nLabels: o}) {
      ...
      }, this.api = e, this.tools = t, this.i18nLabels = o, this.enableShortcuts(), this.nodes = {toolbox: d.make("div", Un.CSS.toolbox)}, this.initPopover(), this.nodes.toolbox.setAttribute("data-cy", "toolbox"), this.api.events.on(xe, this.handleMobileLayoutToggle)
    }
    ...
    initPopover() {
      ...
      this.popover = new e({
        ...
        searchable: !0,
        messages: {nothingFound: this.i18nLabels.nothingFound, search: this.i18nLabels.filter},
    ...
    enableShortcutForTool(e, t) {
      be.add({
        name: t, on: this.api.ui.nodes.redactor, handler: async o => {
          o.preventDefault();
    ...
    async insertNewBlock(e, t) {
      ...
      a.call(te.APPEND_CALLBACK), this.api.caret.setToBlock(s), this.emit("toolbox-block-added", {block: a}), this.api.toolbar.close()
    }
  };
  Jo([fe], wt.prototype, "toolsToBeDisplayed", 1), Jo([fe], wt.prototype, "toolboxItemsToBeDisplayed", 1);
  let ms = wt;
  ...
  class vs extends E {
    ...
    get toolbox() {
      var e;
      return {
        opened: (e = this.toolboxInstance) == null ? void 0 : e.opened, close: () => {
          var t;
    ...
    moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
      ...
      let i;
      const s = 20, r = e.firstInput, a = t.getBoundingClientRect(),
        l = r !== void 0 ? r.getBoundingClientRect() : null, c = l !== null ? l.top - a.top : null,
        u = c !== null ? c > s : void 0;
      if (o) i = t.offsetTop + t.offsetHeight; else if (r === void 0 || u) {
        const h = parseInt(window.getComputedStyle(e.pluginsContent).paddingTop);
        i = t.offsetTop + h
      } else {
        const h = ri(r), p = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10), g = 8;
    ...
    async make() {
      ...
      }), d.append(this.nodes.wrapper, this.nodes.content), d.append(this.nodes.content, this.nodes.actions), this.nodes.plusButton = d.make("div", this.CSS.plusButton, {innerHTML: qi}), d.append(this.nodes.actions, this.nodes.plusButton), this.readOnlyMutableListeners.on(this.nodes.plusButton, "click", () => {
        Ne(!0), this.plusButtonClicked()
      }, !1);
      const e = d.make("div");
      e.appendChild(document.createTextNode(H.ui(W.ui.toolbar.toolbox, "Add"))), e.appendChild(d.make("div", this.CSS.plusButtonShortcut, {textContent: "/"})), Re(this.nodes.plusButton, e, {hidingDelay: 400}), this.nodes.settingsToggler = d.make("span", this.CSS.settingsToggler, {innerHTML: Vi}), d.append(this.nodes.actions, this.nodes.settingsToggler);
      const t = d.make("div"), o = d.text(H.ui(W.ui.blockTunes.toggler, "Click to tune")), i = await bs("Slash", "/");
      t.appendChild(o), t.appendChild(d.make("div", this.CSS.plusButtonShortcut, {textContent: it(`CMD + ${i}`)})), Re(this.nodes.settingsToggler, t, {hidingDelay: 400}), d.append(this.nodes.actions, this.makeToolbox()), d.append(this.nodes.actions, this.Editor.BlockSettings.getElement()), d.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper)
    }

    makeToolbox() {
      return this.toolboxInstance = new ms({
        api: this.Editor.API.methods,
        tools: this.Editor.Tools.blockTools,
        i18nLabels: {filter: H.ui(W.ui.popover, "Filter"), nothingFound: H.ui(W.ui.popover, "Nothing found")}
    ...
    enableModuleBindings() {
      ...
      }, !0), ge() || this.eventsDispatcher.on(Qo, e => {
        var t;
  ...
  var ce = (n => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(ce || {}),
    je = (n => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(je || {}),
    en = (n => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(en || {}),
    ve = (n => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(ve || {}),
    He = (n => (n.IsInline = "isInline", n.Title = "title", n.IsReadOnlySupported = "isReadOnlySupported", n))(He || {}),
  ...
  class xt {
    ...
    prepare() {
      if (M(this.constructable.prepare)) return this.constructable.prepare({toolName: this.name, config: this.settings})
    }
  ...
  class ks extends E {
    constructor({config: e, eventsDispatcher: t}) {
      super({
        config: e,
        eventsDispatcher: t
      }), this.CSS = {inlineToolbar: "ce-inline-toolbar"}, this.opened = !1, this.popover = null, this.toolbarVerticalMargin = ge() ? 20 : 6, this.tools = new Map, window.requestIdleCallback(() => {
        this.make()
      }, {timeout: 2e3})
    }
    ...
    close() {
      ...
      if (this.opened) {
        for (const [o, i] of this.tools) {
          ...
          s !== void 0 && be.remove(this.Editor.UI.nodes.redactor, s), M(i.clear) && i.clear()
        }
    ...
    move(e) {
      const t = b.rect, o = this.Editor.UI.nodes.wrapper.getBoundingClientRect(),
    ...
    createToolsInstances() {
      this.tools = new Map, this.getTools().forEach(t => {
        const o = t.create();
        this.tools.set(t, o)
      })
    }
    ...
    async getPopoverItems() {
      ...
      for (const [o, i] of this.tools) {
        ...
        const a = r !== void 0 ? it(r) : void 0, l = H.t(W.toolNames, o.title || Le(o.name));
        [s].flat().forEach(c => {
          var h, p;
          const u = {
            name: o.name, onActivate: () => {
              this.toolClicked(i)
            }, hint: {title: l, description: a}
          };
          if (d.isElement(c)) {
            const g = {...u, element: c, type: _.Html};
            ...
            ...u, ...c,
            type: _.Html
          }); else if (c.type === _.Separator) e.push({type: _.Separator}); else {
            const g = {...u, ...c, type: _.Default};
    ...
    getToolShortcut(e) {
      ...
      return Array.from(i.keys()).includes(e) ? this.inlineTools[e][en.Shortcut] : o == null ? void 0 : o.shortcut
    }
  ...
  var nn = {}, Bt = {}, Ue = {}, de = {}, Ct = {}, Tt = {};
  Object.defineProperty(Tt, "__esModule", {value: !0}), Tt.allInputsSelector = ys;
  ...
  var ue = {}, St = {};
  Object.defineProperty(St, "__esModule", {value: !0}), St.isNativeInput = ws;
  ...
  var Ot = {}, _t = {};
  Object.defineProperty(_t, "__esModule", {value: !0}), _t.blockElements = xs;
  ...
  var rn = {}, Mt = {};
  Object.defineProperty(Mt, "__esModule", {value: !0}), Mt.calculateBaseline = Bs;

  function Bs(n) {
    var e = window.getComputedStyle(n), t = parseFloat(e.fontSize), o = parseFloat(e.lineHeight) || t * 1.2,
      i = parseFloat(e.paddingTop), s = parseFloat(e.borderTopWidth), r = parseFloat(e.marginTop), a = t * .8,
      l = (o - t) / 2, c = r + s + i + l + a;
    return c
  }
  ...
  var an = {}, At = {}, Lt = {}, Pt = {};
  Object.defineProperty(Pt, "__esModule", {value: !0}), Pt.isContentEditable = Cs;
  ...
  })(Lt), Object.defineProperty(At, "__esModule", {value: !0}), At.canSetCaret = Is;
  var Ts = ue, Ss = Lt;

  function Is(n) {
    var e = !0;
    if ((0, Ts.isNativeInput)(n)) switch (n.type) {
      case"file":
      case"checkbox":
      case"radio":
      case"hidden":
  ...
  const Ms = () => typeof window < "u" && window.navigator !== null && Rt(window.navigator.platform) && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
  ...
  function Dt(n, ...e) {
    if (!e.length) return n;
    const t = e.shift();
    if (Ye(n) && Ye(t)) for (const o in t) Ye(t[o]) ? (n[o] === void 0 && Object.assign(n, {[o]: {}}), Dt(n[o], t[o])) : Object.assign(n, {[o]: t[o]});
    return Dt(n, ...e)
  }
  ...
  const Ft = Yn(Object.freeze(Object.defineProperty({
    __proto__: null,
    PromiseQueue: Xs,
    beautifyShortcut: As,
    cacheable: Os,
  ...
  Object.defineProperty(Nt, "__esModule", {value: !0}), Nt.containsOnlyInlineElements = Gs;
  var qs = Ft, Zs = Ot;

  function Gs(n) {
    var e;
    (0, qs.isString)(n) ? (e = document.createElement("div"), e.innerHTML = n) : e = n;
    var t = function (o) {
      return !(0, Zs.blockElements)().includes(o.tagName.toLowerCase()) && Array.from(o.children).every(t)
    };
  ...
  })(Ke), Object.defineProperty(jt, "__esModule", {value: !0}), jt.fragmentToString = er;
  var Qs = Ke;
  ...
  var un = {}, $t = {};
  Object.defineProperty($t, "__esModule", {value: !0}), $t.getContentLength = or;
  var tr = ue;

  function or(n) {
    var e, t;
    return (0, tr.isNativeInput)(n) ? n.value.length : n.nodeType === Node.TEXT_NODE ? n.length : (t = (e = n.textContent) === null || e === void 0 ? void 0 : e.length) !== null && t !== void 0 ? t : 0
  }
  ...
  var zt = {}, Ut = {}, hn = J && J.__spreadArray || function (n, e, t) {
    if (t || arguments.length === 2) for (var o = 0, i = e.length, s; o < i; o++) (s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
    return n.concat(s || Array.prototype.slice.call(e))
  };
  Object.defineProperty(Ut, "__esModule", {value: !0}), Ut.getDeepestBlockElements = pn;
  var nr = We;

  function pn(n) {
    return (0, nr.containsOnlyInlineElements)(n) ? [n] : Array.from(n.children).reduce(function (e, t) {
  ...
  var fn = {}, Wt = {}, Xe = {}, Yt = {};
  Object.defineProperty(Yt, "__esModule", {value: !0}), Yt.isLineBreakTag = ir;
  ...
  var Ve = {}, Kt = {};
  Object.defineProperty(Kt, "__esModule", {value: !0}), Kt.isSingleTag = sr;
  ...
  })(Ve), Object.defineProperty(Wt, "__esModule", {value: !0}), Wt.getDeepestNode = gn;
  var rr = ue, ar = Xe, lr = Ve;
  ...
  function gn(n, e) {
    ...
    if (n.nodeType === Node.ELEMENT_NODE && n[t]) {
      var i = n[t];
      if ((0, lr.isSingleTag)(i) && !(0, rr.isNativeInput)(i) && !(0, ar.isLineBreakTag)(i)) if (i[o]) i = i[o]; else if (i.parentNode !== null && i.parentNode[o]) i = i.parentNode[o]; else return i.parentNode;
      return gn(i, e)
    }
    return n
  }
  ...
  var mn = {}, Xt = {}, qe = J && J.__spreadArray || function (n, e, t) {
    if (t || arguments.length === 2) for (var o = 0, i = e.length, s; o < i; o++) (s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
    return n.concat(s || Array.prototype.slice.call(e))
  };
  Object.defineProperty(Xt, "__esModule", {value: !0}), Xt.findAllInputs = pr;
  var cr = We, dr = zt, ur = Ct, hr = ue;

  function pr(n) {
    return Array.from(n.querySelectorAll((0, ur.allInputsSelector)())).reduce(function (e, t) {
      return (0, hr.isNativeInput)(t) || (0, cr.containsOnlyInlineElements)(t) ? qe(qe([], e, !0), [t], !1) : qe(qe([], e, !0), (0, dr.getDeepestBlockElements)(t), !0)
    }, [])
  }
  ...
  var bn = {}, Vt = {};
  Object.defineProperty(Vt, "__esModule", {value: !0}), Vt.isCollapsedWhitespaces = fr;
  ...
  function mr(n) {
    return (0, gr.isNumber)(n) ? !1 : !!n && !!n.nodeType && n.nodeType === Node.ELEMENT_NODE
  }
  ...
  var eo = {}, to = {};
  Object.defineProperty(to, "__esModule", {value: !0}), to.isNodeEmpty = Er;
  var vr = Xe, kr = qt, yr = ue, wr = Ve;

  function Er(n, e) {
    var t = "";
    return (0, wr.isSingleTag)(n) && !(0, vr.isLineBreakTag)(n) ? !1 : ((0, kr.isElement)(n) && (0, yr.isNativeInput)(n) ? t = n.value : n.textContent !== null && (t = n.textContent.replace("​", "")), e !== void 0 && (t = t.replace(new RegExp(e, "g"), "")), t.trim().length === 0)
  }
  ...
  })(eo), Object.defineProperty(Gt, "__esModule", {value: !0}), Gt.isEmpty = Cr;
  var xr = Jt, Br = eo;
  ...
  function Cr(n, e) {
    ...
    for (var t = [n]; t.length > 0;) {
      var o = t.shift();
      if (o) {
        if (n = o, (0, xr.isLeaf)(n) && !(0, Br.isNodeEmpty)(n, e)) return !1;
  ...
  var kn = {}, oo = {};
  Object.defineProperty(oo, "__esModule", {value: !0}), oo.isFragment = Sr;
  var Tr = Ft;

  function Sr(n) {
    return (0, Tr.isNumber)(n) ? !1 : !!n && !!n.nodeType && n.nodeType === Node.DOCUMENT_FRAGMENT_NODE
  }
  ...
  var yn = {}, no = {};
  Object.defineProperty(no, "__esModule", {value: !0}), no.isHTMLString = Or;
  var Ir = Ke;
  ...
  function _r(n) {
    var e = n.getBoundingClientRect(), t = window.pageXOffset || document.documentElement.scrollLeft,
      o = window.pageYOffset || document.documentElement.scrollTop, i = e.top + o, s = e.left + t;
  ...
  var Ze = {};
  Object.defineProperty(Ze, "__esModule", {value: !0}), Ze.getContenteditableSlice = Lr;
  var Ar = de;
  ...
  Object.defineProperty(Ue, "__esModule", {value: !0}), Ue.checkContenteditableSliceForEmptiness = Rr;
  var Pr = de, Nr = Ze;
  ...
  var ao = {}, Ge = {};
  Object.defineProperty(Ge, "__esModule", {value: !0}), Ge.getCaretNodeAndOffset = jr;
  ...
  var Tn = {}, lo = {};
  Object.defineProperty(lo, "__esModule", {value: !0}), lo.isCaretAtEndOfInput = Ur;
  var Sn = de, $r = ao, zr = Bt;

  function Ur(n) {
    var e = (0, Sn.getDeepestNode)(n, !0);
    if (e === null) return !0;
    if ((0, Sn.isNativeInput)(e)) return e.selectionEnd === e.value.length;
    var t = (0, $r.getCaretNodeAndOffset)(), o = t[0], i = t[1];
    return o === null ? !1 : (0, zr.checkContenteditableSliceForEmptiness)(n, o, i, "right")
  }
  ...
  var In = {}, co = {};
  Object.defineProperty(co, "__esModule", {value: !0}), co.isCaretAtStartOfInput = Kr;
  var Qe = de, Wr = Ge, Yr = Ue;
  ...
  function Kr(n) {
    ...
    var t = (0, Wr.getCaretNodeAndOffset)(), o = t[0], i = t[1];
    return o === null ? !1 : (0, Yr.checkContenteditableSliceForEmptiness)(n, o, i, "left")
  }
  ...
  function qr() {
    var n = (0, Vr.getRange)(), e = (0, Xr.make)("span");
  ...
  class Zr extends E {
    ...
    beforeKeydownProcessing(e) {
      this.needToolbarClosing(e) && Eo(e.keyCode) && (this.Editor.Toolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || this.Editor.BlockSelection.clearSelection(e))
    }
    ...
    enter(e) {
      ...
      if (i === void 0 || i.tool.isLineBreaksEnabled || o.someToolbarOpened && o.someFlipperButtonFocused || e.shiftKey && !rt) return;
      let s = i;
      i.currentInput !== void 0 && $e(i.currentInput) && !i.hasMedia ? this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex) : i.currentInput && ze(i.currentInput) ? s = this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex + 1) : s = this.Editor.BlockManager.split(), this.Editor.Caret.setToBlock(s), this.Editor.Toolbar.moveAndOpen(s), e.preventDefault()
    }

    backspace(e) {
      const {BlockManager: t, Caret: o} = this.Editor, {currentBlock: i, previousBlock: s} = t;
      if (i === void 0 || !b.isCollapsed || !i.currentInput || !$e(i.currentInput)) return;
    ...
    mergeBlocks(e, t) {
      ...
      e.lastInput !== void 0 && (nn.focus(e.lastInput, !1), o.mergeBlocks(e, t).then(() => {
        i.close()
      }))
    }

    arrowRightAndDown(e) {
      const t = ae.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === y.TAB);
      if (this.Editor.UI.someToolbarOpened && t) return;
      this.Editor.Toolbar.close();
      const {currentBlock: o} = this.Editor.BlockManager,
        s = ((o == null ? void 0 : o.currentInput) !== void 0 ? ze(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
    ...
    arrowLeftAndUp(e) {
      if (this.Editor.UI.someToolbarOpened) {
        if (ae.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === y.TAB)) return;
        this.Editor.UI.closeAllToolbars()
      }
      this.Editor.Toolbar.close();
      const {currentBlock: t} = this.Editor.BlockManager,
        i = ((t == null ? void 0 : t.currentInput) !== void 0 ? $e(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
    ...
    needToolbarClosing(e) {
      const t = e.keyCode === y.ENTER && this.Editor.Toolbar.toolbox.opened,
        ...
        i = e.keyCode === y.ENTER && this.Editor.InlineToolbar.opened, s = e.keyCode === y.TAB;
  ...
  class ho {
    ...
    insert(e, t, o = !1) {
      ...
      e > this.length && (e = this.length), o && (this.blocks[e].holder.remove(), this.blocks[e].call(te.REMOVED));
      const i = o ? 1 : 0;
    ...
    remove(e) {
      isNaN(e) && (e = this.length - 1), this.blocks[e].holder.remove(), this.blocks[e].call(te.REMOVED), this.blocks.splice(e, 1)
    }

    removeAll() {
      this.workingArea.innerHTML = "", this.blocks.forEach(e => e.call(te.REMOVED)), this.blocks.length = 0
    }
    ...
    insertToDOM(e, t, o) {
      t ? o.holder.insertAdjacentElement(t, e.holder) : this.workingArea.appendChild(e.holder), e.call(te.RENDERED)
    }
  ...
  const _n = "block-removed", Mn = "block-added", Gr = "block-moved", An = "block-changed";
  ...
  class Qr extends E {
    ...
    composeBlock({tool: e, data: t = {}, id: o = void 0, tunes: i = {}}) {
      const s = this.Editor.ReadOnly.isEnabled, r = this.Editor.Tools.blockTools.get(e),
        a = new R({id: o, data: t, tool: r, api: this.Editor.API, readOnly: s, tunesData: i}, this.eventsDispatcher);
    ...
    insert({
      ...
      return r && this.blockDidMutated(_n, this.getBlockByIndex(l), {index: l}), this._blocks.insert(l, c, r), this.blockDidMutated(Mn, c, {index: l}), s ? this.currentBlockIndex = l : l <= this.currentBlockIndex && this.currentBlockIndex++, c
    }
    ...
    async update(e, t, o) {
      ...
      return this._blocks.replace(r, s), this.blockDidMutated(An, s, {index: r}), s
    }
    ...
    insertDefaultBlockAtIndex(e, t = !1) {
      ...
      return this._blocks[e] = o, this.blockDidMutated(Mn, o, {index: e}), t ? this.currentBlockIndex = e : e <= this.currentBlockIndex && this.currentBlockIndex++, o
    }
    ...
    removeBlock(e, t = !0) {
      return new Promise(o => {
        ...
        e.destroy(), this._blocks.remove(i), this.blockDidMutated(_n, e, {index: i}), this.currentBlockIndex >= i && this.currentBlockIndex--, this.blocks.length ? i === 0 && (this.currentBlockIndex = 0) : (this.unsetCurrentBlock(), t && this.insert()), o()
      })
    }
    ...
    move(e, t = this.currentBlockIndex) {
      ...
      this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Gr, this.currentBlock, {
        fromIndex: t,
        toIndex: e
      })
    }
    ...
    async convert(e, t, o) {
      ...
      const r = await e.exportDataAsString(), a = q(r, s.sanitizeConfig);
    ...
    bindBlockEvents(e) {
      ...
      this.readOnlyMutableListeners.on(e.holder, "keydown", o => {
        ...
        t.dragLeave(o)
      }), e.on("didMutated", o => this.blockDidMutated(An, o, {index: this.getBlockIndex(o)}))
    }
  ...
  class ea extends E {
    ...
    prepare() {
      this.selection = new b, be.add({
        name: "CMD+A", handler: e => {
    ...
    clearSelection(e, t = !1) {
      ...
      const r = e && e instanceof KeyboardEvent, a = r && Eo(e.keyCode);
      if (this.anyBlockSelected && r && a && !b.isSelectionExists) {
        const l = o.removeSelectedBlocks();
        o.insertDefaultBlockAtIndex(l, !0), i.setToBlock(o.currentBlock), Ae(() => {
          const c = e.key;
    ...
    copySelectedBlocks(e) {
      ...
      this.selectedBlocks.forEach(s => {
        const r = q(s.holder.innerHTML, this.sanitizerConfig), a = d.make("p");
...
`), i = t.innerHTML;
  ...
  class et extends E {
    ...
    navigateNext(e = !1) {
      ...
      const {nextInput: s, currentInput: r} = o, a = r !== void 0 ? ze(r) : void 0;
      let l = i;
    ...
    navigatePrevious(e = !1) {
      ...
      if (!t) return !1;
      const {previousInput: i, currentInput: s} = t, r = s !== void 0 ? $e(s) : void 0, a = e || r || !t.focusable;
      return i && a ? (this.setToInput(i, this.positions.END), !0) : o !== null && a ? (this.setToBlock(o, this.positions.END), !0) : !1
    }

    createShadow(e) {
      const t = document.createElement("span");
      t.classList.add(et.CSS.shadowCaret), e.insertAdjacentElement("beforeend", t)
    }
  ...
  class ta extends E {
    ...
    clear(e) {
      const {BlockManager: t, BlockSelection: o, Caret: i} = this.Editor, s = t.blocks.indexOf(this.firstSelectedBlock),
  ...
  class sa extends E {
    constructor({config: e, eventsDispatcher: t}) {
      super({
        config: e,
        eventsDispatcher: t
      }), this.disabled = !1, this.batchingTimeout = null, this.batchingOnChangeQueue = new Map, this.batchTime = ia, this.mutationObserver = new MutationObserver(o => {
  ...
  const Ln = class Wn extends E {
    constructor() {
      super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = e => {
        try {
          ...
          T(`Paste handling for «${e.name}» Tool hasn't been set up because of the error`, "warn", t)
        }
    ...
    async processDataTransfer(e, t = !1) {
      ...
      const c = Object.keys(this.toolsTags).reduce((p, g) => (p[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}, p), {}),
        u = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), {br: {}}), h = q(l, u);
      ...
      t.forEach(i => {
        ...
        o.push(...s), s.forEach(r => {
          if (Object.prototype.hasOwnProperty.call(this.toolsTags, r)) {
            T(`Paste handler for «${e.name}» Tool on «${r}» tag is skipped because it is already used by «${this.toolsTags[r].tool.name}» Tool.`, "warn");
            return
          }
    ...
    getFilesConfig(e) {
      ...
      !o && !i || (o && !Array.isArray(o) && (T(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (T(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter(s => Jn(s) ? !0 : (T(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
        extensions: o || [],
        mimeTypes: i || []
      })
    }
    ...
    getPatternsConfig(e) {
      e.pasteConfig === !1 || !e.pasteConfig.patterns || V(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
        o instanceof RegExp || T(`Pattern ${o} for «${e.name}» Tool is skipped because it should be a Regexp instance.`, "warn"), this.toolsPatterns.push({
          key: t,
          pattern: o,
          tool: e
        })
    ...
    async processFile(e) {
      const t = Gn(e), o = Object.entries(this.toolsFiles).find(([r, {mimeTypes: a, extensions: l}]) => {
    ...
    async processInlinePaste(e) {
      ...
      if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < Wn.PATTERN_PROCESSING_MAX_LENGTH) {
    ...
    insertEditorJSData(e) {
      ...
      dt(e, r => i.blockTools.get(r).sanitizeConfig).forEach(({tool: r, data: a}, l) => {
        let c = !1;
        l === 0 && (c = t.currentBlock && t.currentBlock.tool.isDefault && t.currentBlock.isEmpty);
        const u = t.insert({tool: r, data: a, replace: c});
    ...
    processElementNode(e, t, o) {
      const i = Object.keys(this.toolsTags), s = e, {tool: r} = this.toolsTags[s.tagName] || {},
        a = this.tagsByTool[r == null ? void 0 : r.name] || [], l = i.includes(s.tagName),
        c = d.blockElements.includes(s.tagName.toLowerCase()),
        u = Array.from(s.children).some(({tagName: p}) => i.includes(p) && !a.includes(p)),
  ...
  class aa extends E {
    ...
    throwCriticalError() {
      throw new Oo(`To enable read-only mode all connected tools should support it. Tools ${this.toolsDontSupportReadOnly.join(", ")} don't support read-only mode.`)
    }
  }
  ...
  class Ie extends E {
    ...
    genHTML() {
      const {UI: e} = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper),
        o = d.make("div", Ie.CSS.overlay, {}), i = d.make("div", Ie.CSS.overlayContainer, {}),
        s = d.make("div", Ie.CSS.rect, {});
    ...
    changingRectangle(e) {
      ...
      const {rightPos: t, leftPos: o, index: i} = this.genInfoForMouseSelection(),
        s = this.startX > t && this.mouseX > t, r = this.startX < o && this.mouseX < o;
    ...
    genInfoForMouseSelection() {
      const t = document.body.offsetWidth / 2, o = this.mouseY - window.pageYOffset,
        i = document.elementFromPoint(t, o), s = this.Editor.BlockManager.getBlockByChildNode(i);
      let r;
    ...
    trySelectNextBlock(e) {
      const t = this.stackOfSelected[this.stackOfSelected.length - 1] === e, o = this.stackOfSelected.length, i = 1,
        s = -1, r = 0;
      if (t) return;
      const a = this.stackOfSelected[o - 1] - this.stackOfSelected[o - 2] > 0;
      let l = r;
      o > 1 && (l = a ? i : s);
      const c = e > this.stackOfSelected[o - 1] && l === i, u = e < this.stackOfSelected[o - 1] && l === s,
        p = !(c || u || l === r);
      ...
      return new Promise(t => {
        ...
        if (e.length === 0) i.insert(); else {
          const s = e.map(({type: r, data: a, tunes: l, id: c}) => {
            ...
            let u;
            try {
              u = i.composeBlock({id: c, tool: r, data: a, tunes: l})
            } catch (h) {
  ...
  class ca extends E {
    async save() {
      ...
      try {
        ...
        const s = await Promise.all(i), r = await dt(s, a => t.blockTools.get(a).sanitizeConfig);
  ...
  const da = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
  ...
  class po {
    ...
    constructor({data: e, config: t, api: o, readOnly: i}) {
      ...
      }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : po.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = t.preserveBlank ?? !1
    }
  ...
  class go {
    ...
    render() {
      return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Xi, this.nodes.button
    }
  ...
  class mo {
    ...
    checkState() {
      ...
      if (e) {
        this.nodes.button.innerHTML = Gi, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
        const t = e.getAttribute("href");
        this.nodes.input.value = t !== "null" ? t : "", this.selection.save()
      } else this.nodes.button.innerHTML = zo, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
      return !!e
    }
  ...
  class Pn {
    ...
    async render() {
      ...
      if (t === void 0) return [];
      const o = this.toolsAPI.getBlockTools(), i = await Po(t, o);
      ...
      }, []), r = await t.getActiveToolboxEntry(), a = r !== void 0 ? r.icon : Uo, l = !ge();
      return {
        icon: a,
        name: "convert-to",
        hint: {title: this.i18nAPI.t("Convert to")},
        children: {
          searchable: l, items: s, onOpen: () => {
  ...
  class Nn {
    ...
    make() {
      const e = d.make("div", this.CSS.wrapper), t = Ji, o = d.make("div", this.CSS.info),
  ...
  var fa = Object.defineProperty, ga = Object.getOwnPropertyDescriptor, Rn = (n, e, t, o) => {
    for (var i = o > 1 ? void 0 : o ? ga(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
    return o && i && fa(e, t, i), i
  };

  class bo extends xt {
    constructor() {
      super(...arguments), this.type = ce.Block, this.inlineTools = new F, this.tunes = new F
    }
    ...
    get toolbox() {
      const e = this.constructable[ve.Toolbox], t = this.config[je.Toolbox];
      if (!V(e) && t !== !1) return t ? Array.isArray(e) ? Array.isArray(t) ? t.map((o, i) => {
        const s = e[i];
        return s ? {...s, ...o} : o
      }) : [t] : Array.isArray(t) ? t : [{...e, ...t}] : Array.isArray(e) ? e : [e]
    }
  ...
  Rn([fe], bo.prototype, "sanitizeConfig", 1), Rn([fe], bo.prototype, "baseSanitizeConfig", 1);
  ...
  class Dn {
    ...
    render() {
      return {icon: $i, title: this.api.i18n.t("Move down"), onActivate: () => this.handleClick(), name: "move-down"}
    }
  ...
  class Fn {
    ...
    render() {
      return {
        ...
        name: "delete",
        confirmation: {title: this.api.i18n.t("Click to delete"), onActivate: () => this.handleClick()}
      }
    }
  ...
  class jn {
    ...
    render() {
      return {icon: Wi, title: this.api.i18n.t("Move up"), onActivate: () => this.handleClick(), name: "move-up"}
    }

    handleClick() {
      const e = this.api.blocks.getCurrentBlockIndex(), t = this.api.blocks.getBlockByIndex(e),
  ...
  jn.isTune = !0;
  var ba = Object.defineProperty, va = Object.getOwnPropertyDescriptor, ka = (n, e, t, o) => {
    for (var i = o > 1 ? void 0 : o ? va(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  class Hn extends E {
    ...
    async prepare() {
      if (this.validateTools(), this.config.tools = nt({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0) throw Error("Can't start without tools");
    ...
    prepareConfig() {
      const e = {};
      for (const t in this.config.tools) N(this.config.tools[t]) ? e[t] = this.config.tools[t] : e[t] = {class: this.config.tools[t]};
      return e
    }
  }
...
`;
  ...
  class wa extends E {
    constructor() {
      super(...arguments), this.isMobile = !1, this.contentRectCache = null, this.resizeDebouncer = Bo(() => {
        this.windowResize()
      }, 200), this.selectionChangeDebounced = Bo(() => {
        this.selectionChanged()
      }, na), this.documentTouchedListener = e => {
    ...
    setIsMobile() {
      ...
      e !== this.isMobile && this.eventsDispatcher.emit(xe, {isEnabled: this.isMobile}), this.isMobile = e
    }
    ...
    loadStyles() {
      ...
      if (d.get(e)) return;
      const t = d.make("style", null, {id: e, textContent: ya.toString()});
    ...
    bindReadOnlyInsensitiveListeners() {
      this.listeners.on(document, "selectionchange", this.selectionChangeDebounced), this.listeners.on(window, "resize", this.resizeDebouncer, {passive: !0}), this.listeners.on(this.nodes.redactor, "mousedown", this.documentTouchedListener, {
        capture: !0,
        passive: !0
      }), this.listeners.on(this.nodes.redactor, "touchstart", this.documentTouchedListener, {capture: !0, passive: !0})
    }
    ...
    watchBlockHoveredEvents() {
      ...
      this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", ot(t => {
        ...
        this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(Qo, {block: this.Editor.BlockManager.getBlockByChildNode(o)}))
      }, 20), {passive: !0})
    }
    ...
    defaultBehaviour(e) {
      const {currentBlock: t} = this.Editor.BlockManager, o = e.target.closest(`.${this.CSS.editorWrapper}`),
    ...
    documentClicked(e) {
      ...
      const i = (a = this.Editor.BlockSettings.nodes.wrapper) == null ? void 0 : a.contains(t),
        s = (l = this.Editor.Toolbar.nodes.settingsToggler) == null ? void 0 : l.contains(t), r = i || s;
    ...
    redactorClicked(e) {
      ...
      if (d.isAnchor(t) && o) {
        ...
        const i = t.getAttribute("href"), s = ei(i);
        oi(s);
        return
      }
    ...
    processBottomZoneClick(e) {
      const t = this.Editor.BlockManager.getBlockByIndex(-1), o = d.offset(t.holder).bottom,
        i = e.pageY, {BlockSelection: s} = this.Editor;
  ...
  class xa {
    ...
    set configuration(e) {
      var o, i;
      N(e) ? this.config = {...e} : this.config = {holder: e}, st(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = ko.VERBOSE), Vn(this.config.logLevel), st(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
      ...
      }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = {blocks: [t]}), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && H.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr"
    }
    ...
    validate() {
      ...
      if (t && N(t) && !d.isElement(t)) throw Error("«holder» value must be an Element node")
    }
    ...
    exportAPI(e) {
      ...
      t.forEach(s => {
        ...
        blocks: {
          clear: "clear",
          render: "render"
        }, caret: {focus: "focus"}, events: {on: "on", off: "off", emit: "emit"}, saver: {save: "save"}
      }).forEach(([s, r]) => {
